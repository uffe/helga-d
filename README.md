...
> Åbn denne side på [https://uffe.github.io/helga-d/](https://uffe.github.io/helga-d/)
...
* søg efter **https://github.com/uffe/helga-d**, og importer

## Rediger dette projekt ![Byggestatus-badge](https://github.com/uffe/helga-d/workflows/MakeCode/badge.svg)

Sådan redigerer du dette lager i MakeCode.

* åbn [https://makecode.microbit.org/](https://makecode.microbit.org/)
* klik på **Importer**, og klik derefter på **Import-URL-adresse**
* indsæt **https://github.com/uffe/helga-d**, og klik på Importer
...
![En genereret visning af blokkene](https://github.com/uffe/helga-d/raw/master/.github/makecode/blocks.png)
